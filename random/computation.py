#Given an array of positive integers, you may repeatedly select the maximum even element and divide all its occurrences by 2.
#Determine the minimum number of operations required to make every element in the array odd.
